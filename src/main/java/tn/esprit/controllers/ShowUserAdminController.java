...
public class ShowUserAdminController implements Initializable {
    ...
    @FXML
    private void modifyUser_clicked(ActionEvent event) {

        try {
            Parent parent2 = FXMLLoader
                    .load(getClass().getResource("/modifyUserAdmin-view.fxml"));
            ...
            Logger.getLogger(ShowUserAdminController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    @FXML
...
// Check the user's response
    ...
    private void returnClicked(ActionEvent event) {
        try {
            ...
            Logger.getLogger(DisplayUsersController.class
                    .getName()).log(Level.SEVERE, null, ex);
        }
    }
