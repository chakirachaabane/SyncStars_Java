...
public class AddUserAdminController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        firstNameTf.setPromptText("Entrez le prénom");
        lastNameTf.setPromptText("Entrez le nom");
        emailTf.setPromptText("Entrez l\'email");
        passwordTf.setPromptText("Entrez le mdps");
        addressTf.setPromptText("Entrez l\'adresse");
        birthDateTf.setPromptText("Entrez la ddn");
        cinTf.setPromptText("Entrez la cin");
        phoneNumberTf.setPromptText(("Entez le num"));
    }
    ...
    void confirmClicked(ActionEvent event) throws NoSuchAlgorithmException {
        ...
        if (email.isEmpty()) {
            ...
            errorMsgEmail.setText("Email non valid");
        } else {
        ...
        if (errorMsgCin.getText().equals("") && errorMsgFirstName.getText().equals("") && errorMsgLastName.getText().equals("") && errorMsgEmail.getText().equals("") && errorMsgPassword.getText().equals("") && errorMsgBirthDate.getText().equals("") && errorMsgGender.getText().equals("") && errorMsgAddress.getText().equals("") && errorMsgPhoneNumber.getText().equals("")) {
            ...
            //****5**** vider les champs des erreurs
            errorMsgFirstName.setText("");
            errorMsgLastName.setText("");
            errorMsgEmail.setText("");
            errorMsgPassword.setText("");
            ...
            successAlert.setTitle("Ajout admin");
